...
function addListItem() {
    if ((title.value != "") && (description.value != "")) {
        ...
        listItem.style.border = "3px solid rgba(172, 255, 47, 0.575)";
        listItem.style.backgroundColor = "honeydew";
        ...
        deleteListItem.style.color = "white";
        deleteListItem.style.backgroundColor = "blue";
        deleteListItem.style.margin = "20px";
